...
<head>
  ...
  <!--[if lt IE 9]>
    ...
    <script src="http://webthemez.com/demo/john-bootstrap-one-page-html5-free-resume-template/js/html5shiv.js"></script>
    <script src="http://webthemez.com/demo/john-bootstrap-one-page-html5-free-resume-template/js/html5element.js"></script>
  <![endif]-->
...
<body>
  <header id="header">
    <div id="head" class="parallax" parallax-speed="2" style="background-position: 50% 0px;">
      ...
      <div class="top_left_cont zoomIn wow animated" id="logo">
        ...
        <h2>Hello! I am Adam Bowles Person test</h2>
    ...
    <div class="portfolio">
      ...
      <div id="filters" class="sixteen columns">
        <ul class="clearfix">
          ...
          <li>
            <a class="" href="#" data-filter=".nature">
              <h5>Designing</h5>
            </a>
          </li>
          <li>
          ...
          <li>
            <a class="" href="#" data-filter=".animals">
              <h5>Mobile App</h5>
            </a>
          </li>
        </ul>
  ...
  <footer class="footer_wrapper" id="contact">
        ...
        <div class="row">
          <div class="col-lg-4 wow fadeInLeft">
            ...
            <ul class="social_links">
              ...
              <li class="facebook animated bounceIn wow delay-03s"><a href="#"><i class="fa fa-facebook"></i></a></li>
              <li class="pinterest animated bounceIn wow delay-04s"><a href="#"><i class="fa fa-pinterest"></i></a></li>
              <li class="github animated bounceIn wow delay-05s"><a href="http://www.github.com/bowlesa"><i class="fa fa-github"></i></a></li>
            </ul>
          </div>
          <div class="col-lg-8 wow fadeInLeft delay-06s">
            <div class="form">
              <input class="input-text" type="text" name="" placeholder="Your name">
              <input class="input-text" type="text" name="" placeholder="Your email">
              <textarea class="input-text text-area" cols="0" rows="0" placeholder="Your message"></textarea>
    ...
    <!--
  <div class="container">
  <div class="footer_bottom"><span>Copyright Â© reserved,  Template by <a href="http://webthemez.com">WebThemez.com</a>. </span> </div>
  </div>
  -->
  </footer>
